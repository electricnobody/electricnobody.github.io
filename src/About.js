  ...
  return (
    <>
      <h1 className="text-center">
        ELECTRIC NOBODY: AI Generated Poems
      </h1>
      <h2>
        A collaboration of Hào AJ Tran and Aerik Francis
      </h2>
      <p>
        <em>ELECTRIC NOBODY</em> is a set of 100 AI generated poem-remixes of the poetry chapbook <em>BODYELECTRONIC</em> by Aerik Francis. Page design, programming, and coding by Hào AJ Tran.
      </p>
      <p>
        <strong>Content Warning</strong>: Some of these generated poems include explicit sexual or violent content, so discretion is recommended when reading.
      </p>
      <h3>
        Artist Bios:
      </h3>
